...
| 技能 | 介绍 | 仓库 |
| --- | --- | --- |
| 前任.skill | 让前任留下一丝神识 | [therealXiaomanChu/ex-skill](https://github.com/therealXiaomanChu/ex-skill) |
| 前任.skill（升级版） | 有些告别不是想复合，只是想把那句没说完的话，体面地说完。 | [OpenDemon/ex-skills](https://github.com/OpenDemon/ex-skills) |
| ex.skill | 想再听一次那个熟悉的语气时，用英文版 ex.skill 把聊天节奏、停顿和回不去的关系一起留下。 | [titanwings/ex-skill](https://github.com/titanwings/ex-skill) |
| 前任.skill（疗愈版） | 不只拿回忆反复刀自己，而是顺手把经验教训一起蒸出来，痛苦加一，成长加 n。 | [W1ndys/ex-cure-skill](https://github.com/W1ndys/ex-cure-skill) |
| 初恋.skill | 把记忆里的初恋蒸馏成可以对话的 AI Skill，回到那个最耀眼、也最回不去的盛夏。 | [z969081067-commits/first-love-skill](https://github.com/z969081067-commits/first-love-skill) |
| crush.skill | 喜欢的人未必会回你，但这份心动，至少值得被好好存档。 | [xiaoheizi8/crush-skills](https://github.com/xiaoheizi8/crush-skills) |
| crush.skill（彩排版） | 表白不是冲锋，先彩排一遍总比把真心直接扔进黑箱强。 | [snake-modin/crush-skill](https://github.com/snake-modin/crush-skill) |
...
| ex-friend.skill | 不管是分手、走散还是失去，都试着把那份陪伴感重新整理成可对话的情感支持。 | [guanpu815/ex-friend-skill](https://github.com/guanpu815/ex-friend-skill) |
| codegirl.skill | 把聊天记录、代码提交和 GitHub 动态一起蒸成一个会陪你写代码、也懂你深夜情绪的赛博搭子。 | [xmlans/codegirl-skill](https://github.com/xmlans/codegirl-skill) |
...
| 教授.skill（37学科版） | 一条里内置 37 个学科教授，能在教学、评审和导师模式之间自然切换，适合学术问题一键换脑。 | [aituli/professor-skill](https://github.com/aituli/professor-skill) |
...
| 申论老师.skill | 不只是出题，还会带你拆材料、推思路和自动评分，适合考公申论这种边练边改的训练流。 | [ZN-Ice/Openclaw-Shen-Lun-Teacher-Skill](https://github.com/ZN-Ice/Openclaw-Shen-Lun-Teacher-Skill) |
...
| X导师.skill | 把写作拆成可执行的肌肉记忆，让灵感少迟到，增长别只靠运气。 | [alchaincyf/x-mentor-skill](https://github.com/alchaincyf/x-mentor-skill) |
| 诸子.skill | 不让几个人格轮流念稿，而是真让多视角彼此反驳、收敛，最后再给你一段中立总结。 | [linzzzzzz/zhuzi-skill](https://github.com/linzzzzzz/zhuzi-skill) |
| 神人TV.skill | 把 23 位互联网神人拉进一间屋子点评任何话题，适合创作、辩论和纯抽象娱乐。 | [BeamusWayne/WeirdoTV-Skill](https://github.com/BeamusWayne/WeirdoTV-Skill) |
| 赛博甜老师.skill | 不是学科老师，更像把“小红书清醒同行者”的自剖风格蒸成一个陪你聊成长和情绪的数字人格。 | [wanghanlele12345/sweet-teacher-skill](https://github.com/wanghanlele12345/sweet-teacher-skill) |
| 饕餮.skill | 把优秀 Skill 喂给另一个 Skill，让它边对标边进化，学会把别人的强项吃成自己的。 | [binggandata/bggg-skill-taotie](https://github.com/binggandata/bggg-skill-taotie) |
...
| 孙宇晨.skill | 把高能量叙事、资源调度和注意力经营那套路数装进脑子里，适合想看懂流量与资本的人。 | [alchaincyf/sun-yuchen-perspective](https://github.com/alchaincyf/sun-yuchen-perspective) |
...
| 决策分身.skill | 不是帮你摇摆选项，而是先造一个更冷静、更一致、不那么会自欺的“你”来替你做决定。 | [Deep-Octopus/decision-twin.skill](https://github.com/Deep-Octopus/decision-twin.skill) |
...
| 纪念.skill（伦理版） | 真正值得追思的，不该是粗暴复活，而是有来源、有边界、也有尊严地记住。 | [zfreeya/memorial-skill-builder](https://github.com/zfreeya/memorial-skill-builder) |
...
| 逝者纪念.skill | 把逝者的聊天、照片和故事整理成一个更偏陪伴与回忆的纪念 AI Skill。 | [southeast-syd/memorial-skill](https://github.com/southeast-syd/memorial-skill) |
| EchoMemory | 把聊天、照片、视频和语音一起蒸进去，让离开的人以另一种方式继续陪你说话。 | [quqicolour/EchoMemory](https://github.com/quqicolour/EchoMemory) |
...
| 未来的自己.skill | 更像给未来的你做一套长期可检索的知识档案，把决定、研究和对话洞见一条条沉淀下来。 | [bladngal/notes-to-future-self-skill](https://github.com/bladngal/notes-to-future-self-skill) |
